...
This is an an eigenvalue estiamtion algorithm
...
prev [State Preparation](./07.hhl_imp1.qmd)
next step is [Controlled Rotation & Measurement of the Ancilla Qubit](./09hhl_imp3.qmd)
