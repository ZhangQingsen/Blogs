...
description: 'Understanding Rectified Flow step by step'
format: 
  html:
    code-fold: true
execute: 
...
This document provides a one step simple implementation of the **<span style="color:#188038">Rectified Flow</span> (DDPM)** algorithm.  
This document is based on the paper [Flow Straight and Fast: Learning to Generate and Transfer Data with Rectified Flow](https://arxiv.org/pdf/2209.03003 "ICL2023").  
